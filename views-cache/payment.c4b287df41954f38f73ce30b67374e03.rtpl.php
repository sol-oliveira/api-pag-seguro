                        ...
                        <div id="payment-methods" class="hide">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab-credito" role="tabpanel">
                                    ...
                                    <input type="hidde" value="brand" id="brand_field">
...
scripts.push(function(){    
 ...
 function showError(error)
    ...
    //Método PaymentMethods para obter todos os meios de pagamento
    ...
    });//fechamento método PaymentMethods
      ...
      if(value.length >= 6){
       ...
       PagSeguroDirectPayment.getBrand({
              ...
              success: function(response){       
               ...
               //Método de parcelamento disponíveis ao comprador
               ...
               }); // fechamento método getInstallments
    ...
    }); // fechamento do método GetBrand
  }
 });  // fechamento função number_field
 ...
 /*   function isValidCPF(number) {
    ...
    $("#form-credit").on("submit", function(e){
     ...
     /*   if (!isValidCPF($("#form-debit [name=cpf]").val())) {
        ...
        //método createCardToken, gerar um token 
       ...
       });// fechamento método createCardToken

    }); // fechamento function form-credit
